...
import m.yl.monitor.BloodPressureParser;
import m.yl.monitor.CSCParser;
import m.yl.monitor.CapSenseParser;
import m.yl.monitor.Constants;
import m.yl.monitor.DescriptorParser;
import m.yl.monitor.GattAttributes;
import m.yl.monitor.GlucoseParser;
import m.yl.monitor.HRMParser;
import m.yl.monitor.HTMParser;
import m.yl.monitor.RGBParser;
import m.yl.monitor.RSCParser;
import m.yl.monitor.SensorHubParser;
import m.yl.monitor.UUIDDatabase;
import m.yl.monitor.Utils;

/**
 * Created by Yl on 17/4/10.
 */
...
public class BluetoothLEService extends Service {
     ...
     */
         ...
         * 连接蓝牙都需要，用来管理手机上的蓝牙
         */
        public static BluetoothAdapter mBluetoothAdapter= Application.getInstance().getmBluetoothAdapter();
...
//                broadcastConnectionUpdate(intentAction);
            ...
            public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor,
                ...
                if (status == BluetoothGatt.GATT_SUCCESS) {
                    yLog.e("onDescriptorWrite GATT_SUCCESS------------------->SUCCESS");
                } else if (status == BluetoothGatt.GATT_FAILURE){
                    yLog.e("onDescriptorWrite GATT_FAIL------------------->FAIL");
            ...
            public void onDescriptorRead(BluetoothGatt gatt, BluetoothGattDescriptor descriptor,
                ...
                yLog.e("onDescriptorRead ------------------->GATT_SUCC");
                ...
                if (status == BluetoothGatt.GATT_SUCCESS) {
                    ...
                    yLog.e("onDescriptorRead ------------------->GATT_FAIL");
                }
            ...
            public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic
                ...
                //write操作会调用此方法
                if (status == BluetoothGatt.GATT_SUCCESS) {
                    yLog.e("onCharacteristicWrite ------------------->write success");
            ...
            public void onCharacteristicRead(BluetoothGatt gatt,
                ...
                yLog.e("onCharacteristicWrite ------------------->read");
                ...
                if (status == BluetoothGatt.GATT_SUCCESS) {
                    ...
                    yLog.e("onCharacteristicRead------------------->GATT_SUCC");
            ...
            public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
                 ...
                 */
                yLog.e("onCharacteristicChanged -------------------> changed");
                //notify 会回调用此方法
...
//            super.onMtuChanged(gatt, mtu, status);
                yLog.e("onMtuChanged-------------------->size:"+mtu);
                if (status == BluetoothGatt.GATT_SUCCESS){
                    yLog.e("onMtuChanged-------------------->设置成功");
                }
            }
        };
        ...
        public static boolean refreshDeviceCache(BluetoothGatt gatt) {
            try {
                ...
                yLog.e("An exception occured while refreshing device");
            }
            return false;
        }
        ...
        public void onCreate() {
            ...
            if (!initialize()) {
                yLog.e("Service not initialized");
            }
        }
